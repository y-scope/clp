...
"- Consider the time range of the logs you are searching. Call"
" `search_by_kql_with_timestamp_range` with a KQL query plus and explicit begin and end timestamps."
" Timestamps must be in ISO 8601 format and end with `Z` to indicate UTC"
