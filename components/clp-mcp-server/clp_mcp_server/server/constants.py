...
"- Consider the time range of the logs you are searching. You should call"
" `search_by_kql_with_timestamp_range` with KQL query plus the begin and end timestamps"
