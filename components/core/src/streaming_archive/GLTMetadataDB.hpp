...
namespace streaming_archive {
    ...
    public:
        ...
        public:
            ...
            // Constructors
            explicit GLTFileIterator (MetadataDB* m_db_ptr, SQLiteDB& db, epochtime_t begin_timestamp, epochtime_t end_timestamp, const std::string& file_path, bool in_specific_segment,
        ...
        virtual std::unique_ptr<FileIterator> get_file_iterator (epochtime_t begin_ts, epochtime_t end_ts, const std::string& file_path, bool in_specific_segment,
                                                                 segment_id_t segment_id)
        {
            return std::make_unique<GLTFileIterator>(this, m_db, begin_ts, end_ts, file_path, in_specific_segment, segment_id);
        }
