#ifndef GLT_STREAMING_ARCHIVE_READER_SEGMENTMANAGER_HPP
#define GLT_STREAMING_ARCHIVE_READER_SEGMENTMANAGER_HPP
...
#endif  // GLT_STREAMING_ARCHIVE_READER_SEGMENTMANAGER_HPP
