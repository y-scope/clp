...
constexpr epochtime_t cEpochTimeMin{INT64_MIN};
constexpr epochtime_t cEpochTimeMax{INT64_MAX};
...
constexpr variable_dictionary_id_t cVariableDictionaryIdMax{UINT64_MAX};
using logtype_dictionary_id_t = int64_t;
constexpr logtype_dictionary_id_t cLogtypeDictionaryIdMax{INT64_MAX};
