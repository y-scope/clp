...
public:
    ...
    std::string const& get_schema_file_path() const { return m_parsing_spec_path; }

    bool get_use_heuristic() const { return (m_parsing_spec_path.empty()); }
...
private:
    ...
    std::string m_parsing_spec_path;
