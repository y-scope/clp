...
public:
    ...
    /**
     * Given a file's original ID and a specific message index, the function returns the ID of
     * the file split containing the message, and the ID of the associated archive by reference
     * @param file_orig_id
     * @param message_ix
     * @param archive_id
     * @param file_split_id
