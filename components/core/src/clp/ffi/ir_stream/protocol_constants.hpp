...
constexpr int8_t ValueDouble = 0x55;
constexpr int8_t ValueTrue = 0x56;
constexpr int8_t ValueFalse = 0x57;
constexpr int8_t ValueFourByteEncodingClpStr = 0x58;
constexpr int8_t ValueEightByteEncodingClpStr = 0x59;
