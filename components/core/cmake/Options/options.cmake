...
function (convert_clp_dependency_properties_to_variables)
    set(CLP_NEED_ABSL get_property(DIRECTORY PROPERTY CLP_NEED_ABSL) PARENT_SCOPE)
    set(CLP_NEED_ANTLR get_property(DIRECTORY PROPERTY CLP_NEED_ABSL) PARENT_SCOPE)
    set(CLP_NEED_BOOST get_property(DIRECTORY PROPERTY CLP_NEED_BOOST) PARENT_SCOPE)
    set(CLP_NEED_CATCH2 get_property(DIRECTORY PROPERTY CLP_NEED_CATCH2) PARENT_SCOPE)
    set(CLP_NEED_CURL get_property(DIRECTORY PROPERTY CLP_NEED_CURL) PARENT_SCOPE)
    set(CLP_NEED_DATE get_property(DIRECTORY PROPERTY CLP_NEED_DATE) PARENT_SCOPE)
    set(CLP_NEED_FMT get_property(DIRECTORY PROPERTY CLP_NEED_FMT) PARENT_SCOPE)
    set(CLP_NEED_LOG_SURGEON get_property(DIRECTORY PROPERTY CLP_NEED_LOG_SURGEON) PARENT_SCOPE)
    set(CLP_NEED_LIBARCHIVE get_property(DIRECTORY PROPERTY CLP_NEED_LIBARCHIVE) PARENT_SCOPE)
    set(CLP_NEED_LZMA get_property(DIRECTORY PROPERTY CLP_NEED_LZMA) PARENT_SCOPE)
    set(CLP_NEED_MARIADB get_property(DIRECTORY PROPERTY CLP_NEED_MARIADB) PARENT_SCOPE)
    set(CLP_NEED_MONGOCXX get_property(DIRECTORY PROPERTY CLP_NEED_MONGOCXX) PARENT_SCOPE)
    set(CLP_NEED_MSGPACKCXX get_property(DIRECTORY PROPERTY CLP_NEED_MSGPACKCXX) PARENT_SCOPE)
    set(CLP_NEED_NLOHMANN_JSON get_property(DIRECTORY PROPERTY CLP_NEED_NLOHMANN_JSON) PARENT_SCOPE)
    set(CLP_NEED_OPENSSL get_property(DIRECTORY PROPERTY CLP_NEED_OPENSSL) PARENT_SCOPE)
    set(CLP_NEED_SIMDJSON get_property(DIRECTORY PROPERTY CLP_NEED_SIMDJSON) PARENT_SCOPE)
    set(CLP_NEED_SPDLOG get_property(DIRECTORY PROPERTY CLP_NEED_SPDLOG) PARENT_SCOPE)
    set(CLP_NEED_SQLITE get_property(DIRECTORY PROPERTY CLP_NEED_SQLITE) PARENT_SCOPE)
    set(CLP_NEED_YAMLCPP get_property(DIRECTORY PROPERTY CLP_NEED_YAMLCPP) PARENT_SCOPE)
    set(CLP_NEED_YSTDLIB get_property(DIRECTORY PROPERTY CLP_NEED_YSTDLIB) PARENT_SCOPE)
    set(CLP_NEED_ZSTD get_property(DIRECTORY PROPERTY CLP_NEED_ZSTD) PARENT_SCOPE)
endfunction()
