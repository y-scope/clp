...
TEST_CASE("StreamingCompression", "[StreamingCompression]") {
    ...
    SECTION("zstd single phase compression") {
        ...
        REQUIRE(ErrorCode::Success == decompressor.get_decompressed_stream_region(uncompressed_bytes, decompressed_data, ZSTD_CStreamInSize()));
        REQUIRE(memcmp(uncompressed_data, decompressed_data, ZSTD_CStreamInSize()) == 0);
        memset(decompressed_data, 0, uncompressed_data_size);
        uncompressed_bytes += ZSTD_CStreamInSize();

        REQUIRE(ErrorCode::Success == decompressor.get_decompressed_stream_region(uncompressed_bytes, decompressed_data, uncompressed_data_size/100));
        ...
        REQUIRE(ErrorCode::Success == decompressor.get_decompressed_stream_region(uncompressed_bytes, decompressed_data, uncompressed_data_size/50));
        ...
        REQUIRE(ErrorCode::Success == decompressor.get_decompressed_stream_region(uncompressed_bytes, decompressed_data, uncompressed_data_size/25));
        ...
        REQUIRE(ErrorCode::Success == decompressor.get_decompressed_stream_region(uncompressed_bytes, decompressed_data, uncompressed_data_size/10));
        ...
        REQUIRE(ErrorCode::Success == decompressor.get_decompressed_stream_region(uncompressed_bytes, decompressed_data, uncompressed_data_size/5));
        REQUIRE(memcmp(uncompressed_data, decompressed_data, uncompressed_data_size/5) == 0);
        memset(decompressed_data, 0, uncompressed_data_size);
        uncompressed_bytes += uncompressed_data_size/5;
        REQUIRE(ErrorCode::Success == decompressor.get_decompressed_stream_region(uncompressed_bytes, decompressed_data, uncompressed_data_size/2));
        REQUIRE(memcmp(uncompressed_data, decompressed_data, uncompressed_data_size/2) == 0);
        memset(decompressed_data, 0, uncompressed_data_size);
        uncompressed_bytes += uncompressed_data_size/2;
        REQUIRE(ErrorCode::Success == decompressor.get_decompressed_stream_region(uncompressed_bytes, decompressed_data, uncompressed_data_size));
