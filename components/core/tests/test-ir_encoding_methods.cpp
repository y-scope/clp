...
TEMPLATE_TEST_CASE(
    ...
    constexpr int8_t cOneByteLengthIndicatorTag{
            clp::ffi::ir_stream::cProtocol::Payload::EncodedKeyIdByte
    };
    constexpr int8_t cTwoByteLengthIndicatorTag{
            clp::ffi::ir_stream::cProtocol::Payload::EncodedKeyIdShort
    };
    constexpr int8_t cFourByteLengthIndicatorTag{
            clp::ffi::ir_stream::cProtocol::Payload::EncodedKeyIdInt
    };
