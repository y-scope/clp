...
class SQL_Adapter:
    ...
    def create_mysql_connection(self, disable_localhost_socket_connection: bool = False) -> \
            mysql.connector.MySQLConnection:
        try:
            connection = mysql.connector.connect(
                **self.database_config.get_mysql_connection_params(disable_localhost_socket_connection))
    ...
    def create_mariadb_connection(self, disable_localhost_socket_connection: bool = False) -> mariadb.connection:
        try:
