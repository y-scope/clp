 ...
 * @param {string} searchJobId of the search operation
 *
 ...
 *
 * @param {string} publicationName
 * @param {string} aggregationJobId
 * @returns {Mongo.Cursor} cursor that provides access to the aggregation results
 */
