...
const TIMESTAMP_KEY_HELPER_TEXT = (
    <>
        ...
        {" "}
        <Typography.Link
            href={"https://docs.yscope.com/clp/v0.10.0/user-docs/reference-json-search-syntax.html#characters-that-require-escaping"}
            rel={"noopener"}
            target={"_blank"}
        >
...
const UNSTRUCTURED_HELPER_TEXT = (
    <>
        ...
        {" "}
        <Typography.Link
            href={"https://docs.yscope.com/clp/v0.10.0/user-docs/quick-start/clp-json.html#compressing-unstructured-text-logs"}
            rel={"noopener"}
            target={"_blank"}
        >
            documentation
