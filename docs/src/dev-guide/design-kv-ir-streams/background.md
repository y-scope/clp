...
At a high-level, [clp-s](../../user-guide/core/core-clp-s.md) compresses log events into what we call
...
clp-s uses [clp](../../user-guide/core/core-unstructured/clp.md)'s algorithm to parse and encode
