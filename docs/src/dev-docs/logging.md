...
The CLP Package uses a polyglot architecture, meaning each component family manages its own logging
stack. There is **no single project-wide JSON schema**.
...
* [Operator guide](logging-operator-guide.md): How to configure log levels, capture service logs,
  and understand the component-specific log structures in deployment.
