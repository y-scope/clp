...
[clp-artifact-build]: https://github.com/y-scope/clp/blob/DOCS_VAR_CLP_VERSION/.github/workflows/clp-artifact-build.yaml
[clp-lint]: https://github.com/y-scope/clp/blob/DOCS_VAR_CLP_VERSION/.github/workflows/clp-lint.yaml
