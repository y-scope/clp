...
| query-scheduler       | `clp.query.uncompressed_bytes_scanned_total` | Counter | Total logical uncompressed archive bytes searched by successful tasks |
| query-scheduler       | `clp.query.compressed_bytes_scanned_total` | Counter | Total logical compressed archive bytes searched by successful tasks |
...
| query-scheduler       | `clp.query.uncompressed_bytes_scanned` | Histogram | Logical uncompressed archive bytes scanned per successful search job |
| query-scheduler       | `clp.query.compressed_bytes_scanned` | Histogram | Logical compressed archive bytes scanned per successful search job |
