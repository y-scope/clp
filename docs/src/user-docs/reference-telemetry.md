...
| query-scheduler       | `clp.query.uncompressed_bytes_scanned_total` | Counter | Cumulative uncompressed bytes of archive data searched in successful tasks |
| query-scheduler       | `clp.query.compressed_bytes_scanned_total` | Counter | Cumulative compressed (on-disk) bytes of archive data searched in successful tasks |
...
| query-scheduler       | `clp.query.uncompressed_bytes_scanned` | Histogram | Uncompressed bytes of archive data searched per successful query job |
| query-scheduler       | `clp.query.compressed_bytes_scanned` | Histogram | Compressed (on-disk) bytes of archive data searched per successful query job |
