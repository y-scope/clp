...
def compress_with_clp_package(
    ...
    if compress_job.mode == "clp-json":
        ...
        # output_path needs input_path attached to the end because the output of clp-text
        # decompression has a directory structure that is equivalent to input_path, but stored at
        # decompression_dir. e.g. if input_path was /a/b/c, and decompression_dir was /d/e/f, the
        # decompressed files would be stored at /d/e/f/a/b/c.
        output_path = decompression_dir / input_path
